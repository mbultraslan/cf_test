    ...
    <div class="ml-auto d-flex">
        ...
        <div>
            <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="<?= base_url('assets/dist/img/demo/avatars/avatar-admin.png')?>" class="profile-image rounded-circle" alt="<?= $currentUser['username']; ?>">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<?= base_url('assets/dist/img/demo/avatars/avatar-admin.png')?>" class="rounded-circle profile-image" alt="<?= $currentUser['username']; ?>">
                                            </span>
                        <div class="info-card-text">
                            <div class="fs-lg text-truncate text-truncate-lg"><?= ucfirst($currentUser['first_name']); ?> <?= ucfirst($currentUser['last_name']); ?></div>
                ...
                <a class="dropdown-item fw-500 pt-3 pb-3" href="<?= base_url('logout') ?>">
                    ...
                    <span class="float-right fw-n">&commat;<?= $currentUser['username']; ?></span>
                </a>
            </div>
        </div>
    </div>
