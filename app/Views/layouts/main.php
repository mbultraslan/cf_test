...
<head>
    ...
    <link id="vendorsbundle" rel="stylesheet" media="screen, print"
          href="<?= base_url('assets/dist/css/vendors.bundle.css') ?>">
    <link id="appbundle" rel="stylesheet" media="screen, print"
          href="<?= base_url('assets/dist/css/app.bundle.css') ?>">
    <link id="mytheme" rel="stylesheet" media="screen, print" href="#">
    <link id="myskin" rel="stylesheet" media="screen, print"
          href="<?= base_url('assets/dist/css/skins/skin-master.css') ?>">
    ...
    <link rel="stylesheet" media="screen, print" href="<?= base_url('assets/dist/css/datagrid/datatables/datatables.bundle.css') ?>">
    <link rel="stylesheet" media="screen, print" href="<?= base_url('assets/dist/css/notifications/sweetalert2/sweetalert2.bundle.css') ?>">
            ...
            <main id="js-page-content" role="main" class="page-content">
                <?php if (!empty($breadcrumb)) : ?>
                    <ol class="breadcrumb page-breadcrumb">
                        <?php foreach ($breadcrumb as $b_title => $url) : ?>
                            <li class="breadcrumb-item"><a href="<?= $url ?>"><?= ucfirst($b_title) ?></a></li>
                        <?php endforeach; ?>
                ...
                <?php if (isset($title)): ?>
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon <?= isset($page_icon) ? $page_icon : 'fal fa-globe' ?> '></i> <?= $title ?>
                        ...
                        <?php if (!empty($buttons)): ?>
                            <div class="subheader-block">
                                <?php foreach ($buttons as $button) : ?>
                                    <a
                                            href="<?= isset($button['link']) ? $button['link'] : '#' ?>"
                                        <?= isset($button['action']) ? 'onclick="'.$button['action'].'"' : '' ?>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <ul class="app-list w-auto h-auto p-0 text-left">
                                ...
                                <li>
                                    <a href="<?= base_url('users') ?>" class="app-list-item text-white border-0 m-0">
                                        <div class="icon-stack">
...
<script src="<?= base_url('assets/dist/js/datagrid/datatables/datatables.bundle.js') ?>"></script>
<script src="<?= base_url('assets/dist/js/datagrid/datatables/datatables.export.js') ?>"></script>
<script src="<?= base_url('assets/dist/js/notifications/sweetalert2/sweetalert2.bundle.js')?>"></script>
